...
import { renderFullTable, renderSummarizedTable,
    renderTop3Questions, renderBottom3Questions,
  renderExpandableAnswersTable } from './renderTable.js';
...
if (currentPage === 'reporting.html') {
  document.addEventListener("DOMContentLoaded", () => {
    fetchData(renderExpandableAnswersTable);
  });
}
